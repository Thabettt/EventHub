...
const EventsPage = () => {
  ...
  useEffect(() => {
    ...
    if (
      initialHashRef.current === "#results-top" &&
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0F0F13] text-gray-900 dark:text-gray-200 font-sans transition-colors duration-500">
      ...
      <div className="relative w-full top-0 left-0 right-0 z-0">
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center z-10 w-full ">
            ...
            >
              Find and book unique experiences that match your interests, from
              intimate workshops to massive festivals.
            </motion.p>
          </div>
          ...
          renderItem={(item) => (
            ...
            >
              ...
              <div className="relative z-10">
                <span className="text-4xl mb-4 block filter drop-shadow-lg group-hover:scale-110 transition-transform duration-300 origin-left">
                  {item.icon}
                </span>
      ...
      <div className="relative w-full overflow-hidden leading-none z-30">
        <svg
          className="relative block w-full h-[100px] text-white dark:text-gray-900 fill-current transform rotate-180"
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center space-x-4">
          ...
          <span className="text-gray-400 font-medium uppercase tracking-widest text-xs sm:text-sm bg-white dark:bg-gray-900 px-4 py-1 rounded-full border border-gray-100 dark:border-gray-800 shadow-sm z-10 whitespace-nowrap">
            Browse All Events
          </span>
          <div className="h-[1px] w-12 sm:w-64 bg-gradient-to-r from-transparent via-gray-400 to-transparent opacity-50"></div>
        </div>
