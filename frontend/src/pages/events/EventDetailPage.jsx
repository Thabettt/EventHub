        ...
        <>
          {(deviceInfo.isMobile || deviceInfo.isTablet) && (
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900 relative">
              ...
              <div className="fixed inset-0 top-0 left-0 right-0 h-[75vh] z-0">
                <img
                  src={
                    event.image ||
              ...
              <div className="relative z-10 pt-[60vh] pb-0">
                <div className="bg-white dark:bg-gray-900 rounded-t-[2.5rem] shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.3)] min-h-screen">
                  ...
                  <div className="px-8 pb-12 pt-4">
                    ...
                    {/* Inline Booking Card */}
                    <div className="mb-10 p-5 bg-gray-50 dark:bg-gray-800/50 rounded-3xl border border-gray-100 dark:border-gray-700/50 flex items-center justify-between shadow-sm">
                      <div className="flex flex-col">
                        <span className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider mb-1">Price</span>
                        <div className="flex items-baseline">
                          <span className="text-3xl font-black text-gray-900 dark:text-white">${event.ticketPrice}</span>
                          <span className="text-sm text-gray-400 font-medium ml-1">/ticket</span>
                        </div>
                      </div>
                      ...
                      {!isSoldOut && !isEventPassed ? (
                        <Button
                          ...
                          className="!rounded-2xl !px-8 !py-4 !bg-indigo-600 hover:!bg-indigo-700 !text-white !font-bold !text-sm !shadow-lg shadow-indigo-500/30 transform transition-transform active:scale-95"
                        >
                          GET TICKETS
                        </Button>
                      ) : (
                        <Button
                          variant="secondary"
                          disabled
                          className="!rounded-2xl !px-6 !py-4 opacity-60 cursor-not-allowed font-bold text-sm"
                        >
                            ...
                            <div className="space-y-6">
                              ...
                              <div className="grid grid-cols-2 gap-4 mt-8">
                                <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-2xl border border-orange-100 dark:border-orange-800/30">
                                  <div className="text-orange-500 dark:text-orange-400 text-xs font-bold uppercase mb-1">Total Tickets</div>
                                  <div className="text-2xl font-black text-gray-900 dark:text-white">{event.totalTickets}</div>
                                </div>
                                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-2xl border border-green-100 dark:border-green-800/30">
                                  <div className="text-green-500 dark:text-green-400 text-xs font-bold uppercase mb-1">Available</div>
                                  <div className="text-2xl font-black text-gray-900 dark:text-white">{event.remainingTickets}</div>
                                </div>
                              </div>
                            </div>
                          )}
                          ...
                          {activeTab === "location" && (
                            <div className="space-y-6">
                              ...
                              <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-2xl border border-gray-100 dark:border-gray-700/50">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">{event.location}</p>
                                <p className="text-gray-500 text-sm mt-1">{event.city}, {event.state}</p>
                              </div>
                            </div>
                          )}
                            ...
                            <div className="space-y-6">
                               <div className="flex items-center justify-between bg-gray-900 dark:bg-white text-white dark:text-gray-900 p-6 rounded-2xl shadow-xl">
                                  ...
                                  <div className="flex flex-col items-end">
                                     ...
                                     <div className="text-xs font-bold uppercase tracking-wider opacity-70">24 Reviews</div>
                                  </div>
                               </div>

                               <div className="space-y-4">
                                  {[1, 2].map((i) => (
                                    <div key={i} className="bg-gray-50 dark:bg-gray-800/50 p-5 rounded-2xl border border-gray-100 dark:border-gray-800 hover:bg-white dark:hover:bg-gray-800 transition-colors shadow-sm">
                                      <div className="flex items-center mb-3">
                                         <div className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600" />
                                         <div className="ml-3">
                                            <div className="font-bold text-sm text-gray-900 dark:text-white">Happy User</div>
                                            <div className="text-xs text-gray-400">Verified Attendee</div>
                                         </div>
                                      </div>
                                      <p className="text-sm text-gray-600 dark:text-gray-300 italic">"Absolutely mind-blowing experience. The atmosphere was electric!"</p>
                                    </div>
                                  ))}
                               </div>
                            </div>
