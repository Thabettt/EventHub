...
const HomePage = () => {
  ...
  return (
    <div
      className="min-h-screen bg-gray-50 dark:bg-[#0F0F13] text-gray-900 dark:text-gray-200 font-sans transition-colors duration-500 overflow-x-hidden"
      ...
      <div className="relative z-10 pt-8 pb-20">
          ...
          {nextTicket ? (
            ...
            >
              <div className="absolute inset-0 z-0">
                ...
                <img
                  src={
                    nextTicket.event.images?.[0] ||
                    nextTicket.event.image ||
                  ...
                  <div className="flex flex-wrap gap-6 text-gray-300">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-white">
                          {new Date(nextTicket.event.date).toLocaleDateString(
                            undefined,
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-white">
                          {new Date(nextTicket.event.date).toLocaleTimeString(
                            [],
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-white">
                          {nextTicket.event.location || nextTicket.event.city}
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="bg-white p-2 rounded-lg w-12 h-12 mb-2 flex items-center justify-center">
                          ...
                          <div className="grid grid-cols-3 gap-0.5 w-8 h-8 opacity-80">
                            {[...Array(9)].map((_, i) => (
                              <div
                                key={i}
                                className={`bg-black ${i % 2 === 0 ? "col-span-1" : ""} rounded-[1px]`}
                              />
                            ))}
                          </div>
                        </div>
                        <p className="text-xs font-mono text-gray-400 uppercase tracking-widest">
                          {(nextTicket._id || nextTicket.id || "").substring(
                            0,
                            8,
                          )}
                          ...
            ...
            >
              ...
              <div className="relative z-10 max-w-4xl px-6 py-12">
                ...
                <p className="text-xl text-gray-200 mb-10 max-w-2xl mx-auto font-light">
                  Explore the most happening events in your city. From
                  underground gigs to massive festivals.
                </p>
                <Button
                  to="/events"
                  size="large"
        ...
        <div className="container mx-auto px-1 md:px-4 mb-16">
          <div className="max-w-[96%] mx-auto mb-6 flex justify-between items-end">
            <div>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight text-gray-900 dark:text-white mb-2 drop-shadow-md">
                Discover
              </h2>
            ...
            <Link
              to="/events"
              className="text-indigo-600 dark:text-indigo-400 text-sm font-semibold hover:underline mb-2"
            >
              View Categories
            </Link>
          </div>
          ...
          <div className="max-w-[96%] mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              {
                name: "Music",
                img: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=500&auto=format&fit=crop",
                color: "from-pink-500 to-rose-500",
              },
              {
                name: "Arts",
                img: "https://images.unsplash.com/photo-1544531586-fde5298cdd40?w=500&auto=format&fit=crop",
              ...
              <Link
                to={`/events?category=${cat.name}#results-top`}
                key={idx}
              ...
              >
                <div className="absolute inset-0">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${cat.color} opacity-80 mix-blend-multiply transition-opacity group-hover:opacity-90`}
                  />
