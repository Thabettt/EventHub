      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            ...
            <div className="relative">
              ...
              >
                <option
                  value="all"
                  className="bg-white dark:bg-[#1a1a20] text-gray-900 dark:text-white"
                >
                  All Status
                </option>
                <option
        ...
        {isLoading ? (
          ...
          <div className="text-center py-24 bg-white/50 dark:bg-white/5 rounded-3xl border border-dashed border-gray-300 dark:border-white/10">
            <div className="w-20 h-20 bg-gray-100 dark:bg-white/5 rounded-full flex items-center justify-center mx-auto mb-6 text-4xl">
              🎫
            </div>
            ...
            {!searchTerm && filterStatus === "all" && (
              <Link
                to="/events"
                className="inline-block px-8 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-bold shadow-lg shadow-indigo-900/30 transition-all hover:scale-105"
              >
                Browse Events
              </Link>
            )}
