...
const Card = ({ children, className, heading, gradient }) => (
  <motion.div
    className={`bg-white/90 backdrop-blur-sm rounded-lg shadow-md overflow-hidden mb-8 ${
      className || ""
    }`}
...
const Alert = ({ type, message, onClose }) => (
  ...
  >
    <div
      className={
        type === "success"
          ? "bg-green-50 p-4 rounded-md border-l-4 border-green-400"
          : "bg-red-50 p-4 rounded-md border-l-4 border-red-400"
      }
    >
...
const ProfilePage = () => {
  ...
  if (authLoading) {
    return (
      <div className="fixed inset-0 h-full w-full overflow-hidden flex items-center justify-center bg-gray-50">
        <motion.div
      ...
      <div className="fixed inset-0 h-full w-full overflow-hidden">
        ...
        <div className="fixed inset-0 bg-gray-50">
          <div className="absolute inset-0">
            <motion.div
              className="absolute top-0 -left-10 w-[50%] h-[55%] rounded-full bg-gradient-to-r from-indigo-200 via-blue-200 to-indigo-300 opacity-70 blur-3xl"
              animate={{
                x: [0, 30, 0],
                y: [0, 20, 0],
                scale: [1, 1.06, 0.98, 1],
            ...
            <motion.div
              className="absolute bottom-0 right-0 w-[60%] h-[65%] rounded-full bg-gradient-to-r from-purple-200 via-indigo-200 to-blue-200 opacity-70 blur-3xl"
              animate={{
                x: [0, -25, 0],
                y: [0, -20, 0],
                scale: [1, 1.1, 0.95, 1],
        ...
        <div className="relative min-h-screen flex flex-col justify-center items-center z-10 px-4 py-12">
          <motion.div
            className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-gray-100 w-full max-w-md"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.5 }}
          >
            <motion.div
              className="mx-auto w-12 h-12 mb-6 bg-yellow-500 rounded-full flex items-center justify-center"
            ...
            <h2 className="text-center text-xl font-medium text-gray-900 mb-2">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <Link
                to="/register"
                className="flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200"
              >
                Create account
              </Link>
            </div>
    ...
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 z-0 bg-gray-50">
        <div className="absolute inset-0">
          ...
          <motion.div
            className="absolute top-1/3 left-1/4 w-[35%] h-[35%] rounded-full bg-gradient-to-r from-blue-100 via-indigo-100 to-purple-100 opacity-50 blur-3xl"
            animate={{
              x: [0, 40, 0],
              y: [0, -30, 0],
              scale: [1, 1.2, 0.9, 1],
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <p className="text-gray-600 mt-2">
              Manage your account settings and view bookings
            </p>
          </motion.div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="appearance-none block w-full px-3 py-2.5 pl-10 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 sm:text-sm transition-all duration-200"
                      />
              ...
              <div>
                <div className="flex flex-col sm:flex-row sm:items-center mb-6">
                  ...
                  <div>
                    ...
                    <span className="inline-block bg-indigo-100 text-indigo-800 text-sm px-2 py-1 rounded mt-1">
          ...
          <Card>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <motion.button
                ...
                className="flex items-center justify-center space-x-2 py-2.5 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          ...
          <Card heading="Recent Bookings">
            {isLoading ? (
              <div className="text-center py-8">
                <motion.div
                  className="w-12 h-12 rounded-full border-4 border-indigo-200 border-t-indigo-600 mx-auto"
                  animate={{ rotate: 360 }}
                  transition={{ duration: 1, repeat: Infinity, ease: "linear" }}
                />
              ...
              <div className="text-center py-8">
                <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mx-auto">
                  <Icons.Event className="h-8 w-8 text-indigo-600" />
                </div>
