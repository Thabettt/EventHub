    ...
    <div className="fixed inset-0 h-full w-full overflow-hidden">
      ...
      <div className="fixed inset-0 bg-gray-50">
        <div className="absolute inset-0">
          ...
          <motion.div
            className="absolute top-2/3 right-1/3 w-[35%] h-[35%] rounded-full bg-gradient-to-r from-blue-100 via-indigo-100 to-purple-100 opacity-40 blur-3xl"
            animate={{
              x: [0, -30, 0],
              y: [0, 25, 0],
              scale: [1, 1.2, 0.9, 1],
      ...
      <div className="relative min-h-screen overflow-auto flex flex-col justify-center z-10 px-4">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <motion.h2
            className="text-center text-2xl font-medium text-gray-900 mb-1"
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <motion.div
            className="bg-white/90 backdrop-blur-sm py-8 px-6 shadow-lg sm:rounded-xl border border-gray-100"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
