    ...
    <div className="fixed inset-0 h-full w-full overflow-hidden">
      ...
      <div className="fixed inset-0 bg-gray-50">
        <div className="absolute inset-0">
          ...
          <motion.div
            className="absolute top-0 -right-10 w-[55%] h-[55%] rounded-full bg-gradient-to-r from-blue-200 via-indigo-200 to-indigo-300 opacity-70 blur-3xl"
            animate={{
              x: [0, 20, 0],
              y: [0, 15, 0],
              scale: [1, 1.05, 0.98, 1],
          ...
          <motion.div
            className="absolute bottom-0 left-0 w-[60%] h-[60%] rounded-full bg-gradient-to-r from-purple-200 via-pink-200 to-indigo-200 opacity-70 blur-3xl"
            animate={{
              x: [0, -20, 0],
              y: [0, -15, 0],
              scale: [1, 1.08, 0.95, 1],
          ...
          <motion.div
            className="absolute top-1/3 left-1/4 w-[30%] h-[30%] rounded-full bg-gradient-to-r from-indigo-100 via-blue-100 to-purple-100 opacity-50 blur-3xl"
            animate={{
              x: [0, 40, 0],
              y: [0, -30, 0],
              scale: [1, 1.2, 0.9, 1],
